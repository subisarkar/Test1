...
class Star(object):
  ...
  def __init__(self, exocat_star, star_sed_path, use_planck_spectrum=True):
    """ 
    Parameters
    __________
      exocat_star 	: 	object
    ...
    print "Star temperature:  ", exocat_star.T
  ...
  def read_phenix_spectrum(self, path, star_distance, star_temperature, star_logg, star_f_h, star_radius, star_name):
...
####################### USING PHOENIX BIN_SPECTRA BINARY FILES (h5)
    ...
    #    ph_file = '/Users/user1/Desktop/ExoSim-hubble 2/exosim_h2/data/star/test/Gliese 1214.spec.fits.gz'
    
    ph_file = '/Users/user1/Desktop/ExoSim-nb/exosim_nb/data/star/test/%s.spec.fits.gz'%(star_name)
    print "Star file used:  ",  ph_file
    ...
    print "Star distance:  ", star_distance.rescale(pq.parsec)
